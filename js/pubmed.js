...
function getIdString(searchTerm, searchTerm2, searchTerm3) {
    ...
    var baseLink = 'http://eutils.ncbi.nlm.nih.gov/entrez/eutils/esearch.fcgi?db=pubmed&datetype=pdat&retmax=20&term=english[LANG]+';
    var fullLink = baseLink + searchTerm + ' AND+' + searchTerm2 + '[TIAB]+AND+' + searchTerm3 + '&retmode=json';
